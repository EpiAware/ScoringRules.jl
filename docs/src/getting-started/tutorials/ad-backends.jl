...
ScoringRules.jl composes with Julia's automatic differentiation (AD)
...
[![AD](https://github.com/EpiAware/ScoringRules.jl/actions/workflows/ad.yaml/badge.svg?branch=main)](https://github.com/EpiAware/ScoringRules.jl/actions/workflows/ad.yaml)
