...
```@meta
EditURL = "https://github.com/EpiAware/ScoringRules.jl/blob/main/NEWS.md"
```

# Release notes

ScoringRules.jl follows a hybrid changelog approach:
...
See [GitHub Releases](https://github.com/EpiAware/ScoringRules.jl/releases) for minor/patch
release information.
